            ...
            @if (isset($stripeAccount) && $stripeAccount && $stripeAccount->onboarding_complete)
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-brand-secondary">${{ number_format(($earnings['trainer_earnings'] ?? 0) / 100, 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('trainer.payouts.reports') }}" class="inline-flex items-center text-sm font-medium hover:underline text-brand-secondary">
            ...
            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <a href="{{ route('trainer.payouts.connect') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-brand-primary">
