            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-brand-primary">My Certificates</h2>

                        <div>
                            <select wire:model.live="statusFilter"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-opacity-50 text-sm focus:border-brand-primary focus:ring-brand-primary">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                @if ($certificate->pdf_path)
                                                    <a href="{{ Storage::url($certificate->pdf_path) }}"
                                                       target="_blank"
                                                       data-guide="certificate-download"
                                                       class="inline-flex items-center text-sm font-medium hover:underline text-brand-secondary">
