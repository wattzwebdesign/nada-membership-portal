    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-bold text-brand-primary">Earnings Dashboard</h2>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <dd class="mt-2 text-3xl font-bold text-brand-primary">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <dd class="mt-2 text-3xl font-bold text-brand-secondary">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($perTraining as $item)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-brand-secondary">
                                    ...
                                    <tfoot class="bg-gray-50">
                                        <tr>
                                            ...
                                            <td class="px-6 py-3 text-sm font-bold text-brand-secondary">
                                                ${{ number_format(($earnings['trainer_earnings'] ?? 0) / 100, 2) }}
                                            </td>
                                        </tr>
                                    </tfoot>
