                                ...
                                @foreach ($certificates->take(3) as $certificate)
                                    <div class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @endif
                                            <a href="{{ route('certificates.download', $certificate) }}" data-umami-event="Certificate Download" class="text-gray-400 hover:text-gray-600" title="Download">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <a href="{{ route('clinical-logs.index') }}" data-guide="dashboard-submit-clinicals" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition">
                                ...
                                <span class="text-sm font-medium text-gray-700">Clinical Log Books</span>
                            </a>
