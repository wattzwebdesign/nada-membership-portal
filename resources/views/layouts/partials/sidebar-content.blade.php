...
<div class="shrink-0 border-t border-black/10 px-3 py-4 space-y-1">
    <x-sidebar-link :href="route('account.edit')" :active="request()->routeIs('account.*')" data-guide="nav-account-settings">
        <x-slot name="icon">
    ...
    <x-sidebar-link :href="route('profile.edit')" :active="request()->routeIs('profile.*')" data-guide="nav-profile">
        <x-slot name="icon">
