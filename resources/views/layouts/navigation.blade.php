{{-- Desktop sidebar --}}
<aside class="hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:left-0 lg:w-64 lg:z-30 print:hidden bg-brand-sidebar">
...
<div class="lg:hidden print:hidden" x-data="{ sidebarOpen: false }">
    ...
    <div
        ...
        class="fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-brand-sidebar"
        x-cloak
    >
        {{-- Close button --}}
        <div class="absolute top-0 right-0 pt-4 pr-3">
            <button @click="sidebarOpen = false" class="focus:outline-none text-brand-text">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
